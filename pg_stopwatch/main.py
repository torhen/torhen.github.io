...
class App:
    def __init__(self):
        ...
        button_dx = 170
        button_dy = 70
        self.b1 = Button(self, caption='Reset',      x =20,                                  y=200, dx=button_dx, dy=button_dy, color=(255,255,255), func=self.timer.reset, fontsize=40)
        self.b2 = Button(self, caption='Start/Stop', x=self.screen.get_width()-20-button_dx, y=200, dx=button_dx, dy=button_dy, color=(255,255,255), func=self.timer.pause, fontsize=40)
